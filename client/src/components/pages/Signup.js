            ...
            <div className="container w3-container w3-center w3-animate-opacity">
                <div className="jumbotron">
                    ...
                    <div className="form-group" onSubmit={handleSubmit}>
                        <label for="passwordInput" style={{color: "white"}}>Create Password</label>
                    ...
                    <div className="form-group" onSubmit={handleSubmit}>
                        <label for="passwordConfirm" style={{color: "white"}}>Confirm Password</label>
                        <input style= {{width: "300px", overflowX: "scroll", margin: "auto"}} onChange={e => setPwdCheck(e.target.value)} className="form-control" id="password-confirm" placeholder="Confirm Password" type="password"></input>
                    </div>
